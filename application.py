...
def register():
    if request.method == 'POST':
        ...
        cur.execute("INSERT INTO movingsuggestions.users(username, password, email) VALUES (%s, %s, %s)", (username, password, email))
...
def sign_in():
    if request.method == 'POST':
        ...
        cur.execute("SELECT * FROM movingsuggestions.users WHERE username = %s", (username,))
